...
parser.add_argument("--endday", type=int, default=21)
parser.add_argument("--duration", type=int, default=21)
...
carpark_meta_path = os.path.join(dst_dir, "carpark_meta_three_weeks.geojson")
